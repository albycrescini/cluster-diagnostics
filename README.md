...
The script is accessible from the `/tools` folder, inside which you can find two scripts:
...
3. To run the script, use the following format:
   ...
   For example, to run the script for the `mycluster` cluster, and monitoring the two applications in the `default` namespace you can run:

   ```bash
   ./script.py mycluster default
   ```
...
| ----------- | ------- | ------------------------- | --------- |
| mycluster-m02 | unknown | frontend-8584979b46-5sklj | 1         |
| mycluster-m03 | unknown | frontend-8584979b46-x5422 | 1         |
